...
import { Eye, EyeOff, Mail, Lock, Building, Globe, ArrowRight, AlertCircle, ArrowLeft } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { createDummyUser, setCurrentUser } from '@/lib/dummy-auth';

export function SignupBrandPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newUser = createDummyUser(formData.email, formData.password, 'brand', profileData);
      ...
      <div className="w-full max-w-md">
        ...
        >
          <Link to="/" className="inline-block">
            ...
            <p className="text-gray-600 mt-1">Join as a Brand</p>
          </Link>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={step === 1 ? (e) => { e.preventDefault(); handleNextStep(); } : handleSignup}>
            {step === 1 && (
              ...
              >
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Create your brand account</h2>
                  <p className="text-gray-600">Connect with authentic creators</p>
                </div>
            ...
            {step === 2 && (
              ...
              >
                <div className="mb-6">
                  ...
                  <p className="text-gray-600">Help creators understand your brand</p>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    type="submit"
                    disabled={loading || !formData.companyName || formData.nicheTags.length === 0}
                    className="flex-1"
                  >
                    {loading ? (
                      <>
